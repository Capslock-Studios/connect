const companies = [
    ...
    },
    {
        ...
        products: [
            { id: "pr3", name: "WhatsNext T-shirt", description:"Promotional T-shirt for the whatsnext movement.", price: 450 },
            { id: "pr4", name: "WhatsNext Crop-Top", description:"Promotional Crop top T-shirt for the whatsnext movement.", price: 600 }
        ],
        services: [
            { id: "sv2", name: "Energy Audits", description: "Evaluate your energy efficiency and optimize costs.", price: 1500 }
        ]
    },
    {
        id: "c2",
